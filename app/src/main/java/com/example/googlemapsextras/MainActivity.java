package com.example.googlemapsextras;
    ...
    private void startTimer() {
        ...
        GameCountDownTimer = new CountDownTimer(TimeLeftInMillisGame, 1000) {
            ...
            public void onFinish() {
                ...
                //RENAME MAINACTIVITY TO THE FILE YOU ARE IN NOW OTHERWISE DOESN't WORK EVA!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                startActivity(new Intent(MainActivity.this,GameEndPopUp.class));
